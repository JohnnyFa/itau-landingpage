...
export function SectionHero(){
    return(
        <section className="w-full h-[704px] bg-[url('/bg-hero.jpg')] bg-no-repeat bg-center bg-cover">
            <Container>
                ...
                <button className="flex items-center gap-3">
                        ...
                        <span className="text-white text-sm font-bold">Continue explorando</span></button>
                </div>
                <Image src={Woman} alt="Woman" className="mr-[-42px]"/>
            </Container>
        </section>
    );
}